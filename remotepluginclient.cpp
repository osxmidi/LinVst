...
int RemotePluginClient::sizeShm() {
  ...
  size_t sz = FIXED_SHM_SIZE + SHMVALX + FIXED_SHM_SIZE2 + SHMVALX +
              FIXED_SHM_SIZE3 + SHMVALX + (sizeof(ShmControl) * 5) + 1024;
...
float RemotePluginClient::getVersion() {
  ...
  m_shmControlptr = m_shmControl3;
  m_shmControlptr->ropcode = RemotePluginGetVersion;
  waitForServer(m_shmControlptr);
  retval = m_shmControlptr->retfloat;
  return retval;
}
...
int RemotePluginClient::getParameterCount() {
  ...
  m_shmControlptr = m_shmControl3;
  m_shmControlptr->ropcode = RemotePluginGetParameterCount;
  waitForServer(m_shmControlptr);
  retval = m_shmControlptr->retint;
  return retval;
}
...
int RemotePluginClient::EffectOpen() {
  ...
  m_shmControlptr3->ropcode = RemotePluginEffectOpen;
  waitForServer(m_shmControlptr3);

#ifdef WAVES
  wavesthread = m_shmControlptr3->retint;
  if (wavesthread == 1)
...
int RemotePluginClient::getFlags() {
  ...
  m_shmControlptr = m_shmControl3;
  m_shmControlptr->ropcode = RemotePluginGetFlags;
  waitForServer(m_shmControlptr);
  retval = m_shmControlptr->retint;
  return retval;
}
...
int RemotePluginClient::getinitialDelay() {
  ...
  m_shmControlptr = m_shmControl3;
  m_shmControlptr->ropcode = RemotePluginGetinitialDelay;
  waitForServer(m_shmControlptr);
  retval = m_shmControlptr->retint;
  m_delay = retval;
  return retval;
...
int RemotePluginClient::getInputCount() {
  ...
  m_shmControlptr = m_shmControl3;
  m_shmControlptr->ropcode = RemotePluginGetInputCount;
  waitForServer(m_shmControlptr);
  retval = m_shmControlptr->retint;
  m_numInputs = retval;
  return retval;
...
int RemotePluginClient::getOutputCount() {
  ...
  m_shmControlptr = m_shmControl3;
  m_shmControlptr->ropcode = RemotePluginGetOutputCount;
  waitForServer(m_shmControlptr);
  retval = m_shmControlptr->retint;
  m_numOutputs = retval;
  return retval;
...
int RemotePluginClient::getProgramCount() {
  ...
  m_shmControlptr = m_shmControl3;
  m_shmControlptr->ropcode = RemotePluginGetProgramCount;
  waitForServer(m_shmControlptr);
  retval = m_shmControlptr->retint;
  return retval;
}
...
int RemotePluginClient::getUID() {
  ...
  m_shmControlptr = m_shmControl3;
  m_shmControlptr->ropcode = RemotePluginUniqueID;
  waitForServer(m_shmControlptr);
  retval = m_shmControlptr->retint;
  return retval;
}
