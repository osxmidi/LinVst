...
* */
      ...
      getfin(0), guiupdate(0), guiupdatecount(0), guiresizewidth(500),
...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR cmdline,
  ...
  cerr << "LinVst version 3.6.0" << endl;
  ...
  *ptr = 2000;
  ...
  WaitForMultipleObjects(3, remoteVSTServerInstance->ThreadHandle, TRUE, 5000);
