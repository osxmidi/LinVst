...
BUILD_FLAGS  = -fPIC -O2 -DLVRT -DEMBED -DEMBEDDRAG -DTRACKTIONWM -DVESTIGE $(CXX_FLAGS)
...
BUILD_FLAGS_WIN = -m64 -O2 -DEMBED -DEMBEDDRAG -DTRACKTIONWM -DVESTIGE -I/usr/include/wine-development/windows -I/usr/include/wine-development/wine/windows -I/usr/include/wine/wine/windows
