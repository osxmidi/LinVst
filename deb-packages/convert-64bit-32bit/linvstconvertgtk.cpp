...
int main (int argc, char *argv[])
{
  ...
  gtk_window_set_title (GTK_WINDOW (window), "LinVst-Deb-64-32bit");
  ...
  gtk_file_chooser_set_current_folder (GTK_FILE_CHOOSER (fileselect), "/usr/share/LinVst/64bit-32bit");
