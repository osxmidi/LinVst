...
BUILD_FLAGS  = -fPIC -O2 -DLVRT -DEMBED -DSEM -DEMBEDDRAG -DWAVES $(CXX_FLAGS)
...
BUILD_FLAGS_WIN = -m64 -O2 -DEMBED -DSEM -DEMBEDDRAG -DWAVES -DWAVESLOOP -I/usr/include/wine-development/windows -I/usr/include/wine/wine/windows
