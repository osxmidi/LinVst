...
public:
  ...
  int magic;
  // dispatcher 04-07
  intptr_t VESTIGECALLBACK (*dispatcher)(AEffect *, int, int, intptr_t, void *,
                                         float);
  ...
  void VESTIGECALLBACK (*processDoubleReplacing)(AEffect *, double **,
                                                 double **, int);
  char empty6[56];
};
...
typedef intptr_t VESTIGECALLBACK (*audioMasterCallback)(AEffect *, int32_t,
                                                        int32_t, intptr_t,
                                                        void *, float);
