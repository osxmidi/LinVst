...
BUILD_FLAGS  = -fPIC -O2 -DEMBED -DLVRT -DSEM -DEMBEDDRAG -DEMBEDRESIZE -DEMBEDTHREAD $(CXX_FLAGS)
# add -DEMBEDTHREAD to above line for Ubuntu 14.04
BUILD_FLAGS_WIN = -m64 -O2 -DEMBED -DSEM -DEMBEDDRAG -DEMBEDRESIZE -I/usr/include/wine-development/windows
