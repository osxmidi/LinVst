...
Download wine-10.10-staging-tkg-amd64.tar.xz and wine-10.10-staging-tkg-x86.tar.xz (or any non wow64 versions) from https://github.com/Kron4ek/Wine-Builds/releases (wine version numbers depend on the wine version available)
